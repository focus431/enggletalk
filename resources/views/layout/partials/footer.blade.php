        ...
        <div class="row">
          <div class="col-12 text-center">
            <div class="copyright-text">
              <p class="mb-0">
                &copy; {{ date('Y') }}
                <a href="https://gezhong.com.tw" target="_blank" title="菲律賓遊學與語言學校專家">{{ __('Philippines Study') }}</a>.
                {{ __('All rights reserved.') }}
                <span>{{ __('Professional Philippine study and language school selection, providing you with the best study experience.') }}</span>
              </p>
            </div>
          </div>
        </div>
